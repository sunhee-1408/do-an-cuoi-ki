...
df = pd.read_csv("c:/Users/ngiau_qbk80d3/OneDrive/Máy tính/python/heart.csv", sep=',')
...
Button(crud_entry, text="Chỉnh sửa dữ liệu",font="arial 12", bd=0, bg="pink", cursor="hand2", width=37, command=Edit_Data).place(x=20, y=60)
Button(crud_entry, text="Khôi phục dữ liệu",font="arial 12", bd=0, bg="pink", cursor="hand2", width=37.place(x=20, y=90)
Button(crud_entry, text="Xóa dữ liệu",font="arial 12", bd=0, bg="pink", cursor="hand2", width=37, command=Delete_Data).place(x=20, y=120)
Button(crud_entry, text="Tìm kiếm dữ liệu",font="arial 12", bd=0, bg="pink", cursor="hand2", width=37, command=Search_Data).place(x=20, y=150)
...
Button(crud_entry, text="?", font="arial 14", bd=0, bg=framebg, width=30,command=caa).place(x=20, y=440)
Button(crud_entry, text="?", font="arial 14", bd=0, bg=framebg, width=30,command=thall).place(x=20, y=480)
