...
df = pd.read_csv("c:/Users/ngiau_qbk80d3/OneDrive/Máy tính/python/heart22.csv", sep=',')
...
root.geometry("1400x730") #Kích thước
...
Button(crud_entry, text="Thoát", font="arial 14",  bd=2, bg="blueviolet", cursor="hand2", fg="white", width=10, command=logout).place(x=120, y=760)
root.mainloop()