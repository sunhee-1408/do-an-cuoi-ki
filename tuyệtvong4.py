...
Button(crud_entry, text="Xóa dữ liệu", bd=1, bg=background, cursor="hand2", width=19, command=Delete_Data).place(x=15, y=140)
Button(crud_entry, text='Chỉnh sửa dữ liệu', bd=1, bg=background, cursor='hand2', width=19, command=Edit_Data).place(x=15, y=180)
root.mainloop()
