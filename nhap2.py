...
df = pd.read_csv("c:heart.csv", sep=',')
...
Button(crud_entry, text="Khôi phục dữ liệu",font="arial 12", bd=0, bg="pink", cursor="hand2", width=37,command=Restore_Data).place(x=20, y=90)
